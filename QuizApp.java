...
public class QuizApp {
    ...
    static final int TIMER_SECONDS = 10; 
...
questions.add(new Question("Which keyword is used to define a class in Java?",
                new String[]{" function", " class", "struct", "define"}, 'B'));
questions.add(new Question(" Which of these operators is used to allocate memory for an object in Java?",
                new String[]{"malloc ", "calloc", "new ", "delete "},'C'));
questions.add(new Question("Which method is the entry point for a Java program?",
                new String[]{"main()", "start()", "init() ", "run() "},'A'));
questions.add(new Question("Which of the following is not a valid access modifier in Java? ",
                new String[]{" public", " private", "internal ", "protected "},'C'));
questions.add(new Question("What is the default value of a local variable in Java? ",
                new String[]{"1. Zero", "2.Null", "3. False", "4.No default value "},'D'));
questions.add(new Question("Which of the following is a reserved keyword in Java? ",
                new String[]{"default", "implements", "object", "includes "},'B'));
questions.add(new Question("Which method can be used to find the length of a string in Java?",
                new String[]{"length() ", "size()", "getLength()", "strlen() "},'A'));
questions.add(new Question("What does the 'final' keyword do when applied to a variable in Java? ",
                new String[]{"Makes the variable constant ", "Allows the variable to change dynamically", " Creates an abstract method ", "Implements an interface "},'A'));
questions.add(new Question("What does JVM stands for in java? ",
                new String[]{"Java visual Machine", "Java virtual Machine", " Java Variable Machine", "Java Version Machine "}, 'B'));
...
switch(option)
{
 case "Start" :     for (Question question : questions) {
           ...
           TimerTask task = new TimerTask() {
            ...
            if ((endTime - startTime) / 1000 < TIMER_SECONDS) { 
